...
INSERT INTO `peliculas` VALUES (2, 'Perfume de mujer', 'Drama', 'Charlie está becado en uno de los mejores colegios de Estados Unidos', 5, 5);
INSERT INTO `peliculas` VALUES (3, 'El mercader de venecia', 'Drama', 'Situada en la Venecia del siglo XVI, esta eterna comedia... ', 3, 3);
INSERT INTO `peliculas` VALUES (4, 'Atrapado sin salida', 'Accion', 'Para no entrar en la cárcel, Randle Patrick McMurphy convenció al juez que es...', 4, 4);
...
INSERT INTO `peliculas` VALUES (6, 'El Mago de Oz', 'Ficcion', 'Dorothy es una niña huérfana que se siente infeliz en la granja de sus...', 5, 5);
...
INSERT INTO `peliculas` VALUES (10, 'Cantando bajo la lluvia', 'Musical', 'Con el nacimiento del cine sonoro en 1927, la industria cinematográfica debe renovarse... ', 3, 3);
